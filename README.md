...
App AR que superpone modelos 3D del cuerpo humano sobre marcadores impresos para enseñanza médica.

| Campo | Detalle |
|-------|---------|
| **Tipo XR** | AR |
| **Motor** | Unity 2022.3.62f1 |
| **Tecnología principal** | ARTrackedImageManager + AR Foundation |
...
```bash
git clone https://github.com/RubenCarty/rva-g04-tutor-anatomia-ra.git
cd rva-g04-tutor-anatomia-ra
```
